...
<title>Cadastrar Professor</title>
	...
	cursos = consultar.execute(curso);
	%>
<meta charset="utf-8">
...
<body>
    ...
    <h1>Cadastro do Professor</h1>
        <div class="formulario">
            <form name = "formCurso" action = "cdProfessor" method="get">
                ...
                <div class="centralizar"><input type="text" id="formacao" name="formacao" ></div>
                <label for="email">Email:</label>
                <div class="centralizar"><input type="email" id="email" name="email" ></div>
               	
               	<label for="cpf">Cpf:</label>
                <div class="centralizar"><input type="text" id="cpf" name="cpf"></div>
